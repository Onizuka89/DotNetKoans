...
namespace DotNetKoans.CSharp
{
    public class AboutStrings : Koan
    {
        ...
        {
            var str = "Hello, \"World\"";
            Assert.Equals(FILL_ME_IN, str.Length);
        }
        ...
        public void VerbatimStringsCanHandleFlexibleQuoting()
        {
            ...
            Assert.Equals(FILL_ME_IN, strA.Equals(strB));
        }
...
broken line";
        ...
        public void PlusConcatenationWillNotModifyOriginalStrings()
        {
            ...
            Assert.Equals(FILL_ME_IN, strA);
            Assert.Equals(FILL_ME_IN, strB);
        }
        ...
        public void StringsAreReallyImmutable()
        {
            ...
            var strB = "World";
            strA += strB;
            Assert.Equals(FILL_ME_IN, originalString);
        ...
        public void YouCanGetASubstringFromAString()
        {
            ...
            Assert.Equals(FILL_ME_IN, str.Substring(19));
            Assert.Equals(FILL_ME_IN, str.Substring(7, 3));
        }
        ...
        {
            var str = "Bacon, lettuce and tomato";
            Assert.Equals(FILL_ME_IN, str[0]);
        }
        ...
        public void SingleCharactersAreRepresentedByIntegers()
        {
            Assert.Equals(97, 'a');
            Assert.Equals(98, 'b');
            Assert.Equals(FILL_ME_IN, 'b' == ('a' + 1));
        }
        ...
        public void StringsCanBeSplit()
        {
            ...
            Assert.Equals(new[] { FILL_ME_IN }, words);
        }
